...
train_data_path = pd.read_csv("tr.csv")
...
class Decoder(nn.Module):
    ...
    def forward(self, x):
        # [batch_size, embedding_dim, length]
...
class ESMc_Caps(nn.Module):
    def __init__(self, input_size=1152, output_size1=510, output_size2=200, out_put_dim=16, dropout=0.4):
        ...
        # Caps
        self.caps = CapsLayer(input_caps=self.output_size2, input_dim=122, output_caps=16, output_dim=self.out_put_dim)
...
if __name__ == '__main__':
    ...
    train_ESMc = load_data('train_ESMc.npy')
